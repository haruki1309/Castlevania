...
void Simon::LoadResource()
{
	...
	//turn back
	Sprites::GetInstance()->Add(-201, 249, 7, 265, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//sit left
	Sprites::GetInstance()->Add(-200, 87, 7, 103, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	Sprites::GetInstance()->Add(-199, 4, 7, 20, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-198, 29, 7, 45, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-197, 58, 7, 74, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//upstairs left
	Sprites::GetInstance()->Add(-196, 156, 7, 172, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//downstairs left
	Sprites::GetInstance()->Add(-195, 131, 7, 147, 39, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//stand attack left
	Sprites::GetInstance()->Add(-194, 27, 46, 43, 78, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-193, 58, 46, 74, 78, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-192, 88, 46, 104, 78, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniStandAttackLeft = new Animation(200);
	aniStandAttackLeft->Add(-194);
	aniStandAttackLeft->Add(-193);
	aniStandAttackLeft->Add(-192);
	Animations::GetInstance()->Add(-44, aniStandAttackLeft);
	this->AddAnimation(-44); // 6 animation stand attack left

	//sit attack left
	Sprites::GetInstance()->Add(-191, 26, 91, 42, 123, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-190, 55, 91, 71, 123, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-189, 85, 91, 101, 123, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniSitAttackLeft = new Animation(200);
	aniSitAttackLeft->Add(-191);
	aniSitAttackLeft->Add(-190);
	aniSitAttackLeft->Add(-189);
	Animations::GetInstance()->Add(-43, aniSitAttackLeft);
	this->AddAnimation(-43); // 7 animation sit attack left

	//upstairs attack left
	Sprites::GetInstance()->Add(-188, 129, 47, 145, 79, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-187, 159, 47, 175, 79, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-186, 194, 47, 210, 79, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniUpStairsAttackLeft = new Animation(200);
	aniUpStairsAttackLeft->Add(-188);
	aniUpStairsAttackLeft->Add(-187);
	aniUpStairsAttackLeft->Add(-186);
	...
	Sprites::GetInstance()->Add(-185, 129, 91, 145, 123, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-184, 158, 91, 174, 123, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-183, 194, 91, 210, 123, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniDownStairsAttackLeft = new Animation(200);
	aniDownStairsAttackLeft->Add(-185);
	aniDownStairsAttackLeft->Add(-184);
	aniDownStairsAttackLeft->Add(-183);
	Animations::GetInstance()->Add(-41, aniDownStairsAttackLeft);
	this->AddAnimation(-41); // 9 animation downstairs attack left

	//eat sp item left
	Sprites::GetInstance()->Add(-182, 228, 89, 224, 121, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-181, 252, 89, 268, 121, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-180, 227, 47, 243, 79, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-179, 249, 47, 265, 79, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//======================================================================
	//sit right
	Sprites::GetInstance()->Add(-178, 172, 136, 188, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	Sprites::GetInstance()->Add(-177, 255, 136, 271, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-176, 230, 136, 247, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-175, 201, 136, 217, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//upstairs right
	Sprites::GetInstance()->Add(-174, 103, 136, 119, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//downstairs right
	Sprites::GetInstance()->Add(-173, 128, 136, 145, 168, Textures::GetInstance()->GetTexture(-1), simonPos);
	...
	//stand attack right
	Sprites::GetInstance()->Add(-172, 232, 175, 248, 207, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-171, 201, 175, 217, 207, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-170, 171, 175, 187, 207, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniStandAttackRight = new Animation(200);
	aniStandAttackRight->Add(-172);
	aniStandAttackRight->Add(-171);
	aniStandAttackRight->Add(-170);
	Animations::GetInstance()->Add(-34, aniStandAttackRight);
	this->AddAnimation(-34); // 16 animation stand attack right

	//sit attack right
	Sprites::GetInstance()->Add(-169, 233, 220, 249, 252, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-168, 204, 220, 220, 252, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-167, 174, 220, 190, 252, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniSitAttackRight = new Animation(200);
	aniSitAttackRight->Add(-169);
	aniSitAttackRight->Add(-168);
	aniSitAttackRight->Add(-167);
	Animations::GetInstance()->Add(-33, aniSitAttackRight);
	this->AddAnimation(-33); // 17 animation sit attack right

	//upstairs attack right
	Sprites::GetInstance()->Add(-166, 130, 176, 146, 208, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-165, 100, 176, 116, 208, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-164, 65, 176, 81, 208, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniUpStairsAttackRight = new Animation(200);
	aniUpStairsAttackRight->Add(-166);
	aniUpStairsAttackRight->Add(-165);
	aniUpStairsAttackRight->Add(-164);
	...
	Sprites::GetInstance()->Add(-163, 130, 220, 146, 252, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-162, 101, 220, 117, 252, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-161, 65, 220, 81, 252, Textures::GetInstance()->GetTexture(-1), simonPos);

	LPANIMATION aniDownStairsAttackRight = new Animation(200);
	aniDownStairsAttackRight->Add(-163);
	aniDownStairsAttackRight->Add(-162);
	aniDownStairsAttackRight->Add(-161);
	Animations::GetInstance()->Add(-31, aniDownStairsAttackRight);
	this->AddAnimation(-31); // 19 animation downstairs attack right

	//eat sp item right
	Sprites::GetInstance()->Add(-160, 31, 218, 47, 250, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-159, 7, 218, 23, 250, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-158, 32, 176, 48, 208, Textures::GetInstance()->GetTexture(-1), simonPos);
	Sprites::GetInstance()->Add(-157, 10, 176, 26, 208, Textures::GetInstance()->GetTexture(-1), simonPos);
...
void Simon::HandleMove()
{
	if (InputDevice::GetInstance()->IsKeyDown(DIK_RIGHTARROW) && isGrounded && !isAttack)
	{
		...
		if (InputDevice::GetInstance()->IsKeyDown(DIK_SPACE))
		{
	...
	else if (InputDevice::GetInstance()->IsKeyDown(DIK_DOWNARROW) && isGrounded)
	{
